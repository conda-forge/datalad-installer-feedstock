About datalad-installer-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/datalad-installer-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/datalad-installer-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add datalad-installer
# for installing globally
pixi global install datalad-installer
```
...
It is possible to list all of the versions of `datalad-installer` available on your platform:
...
```
pixi search datalad-installer --channel conda-forge
```
