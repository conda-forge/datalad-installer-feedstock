...
Once the `conda-forge` channel has been enabled, `datalad-installer` can be installed with:

```
conda install datalad-installer
```

It is possible to list all of the versions of `datalad-installer` available on your platform with:
